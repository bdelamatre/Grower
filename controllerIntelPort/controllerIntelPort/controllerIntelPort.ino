...
#include <SD.h>
#include <Wire.h> 
#include <GnomeDateTime.h> //Chronodot by Stephanie-Maks
...
void loop(){
  ...
  //#if defined(USETHERNETCOM)
   
      /*readEthernetToBuffer(client,commandBufferEthernet,commandBufferPositionEthernet,commandBufferReadyToProcessEthernet);
