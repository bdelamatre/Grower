...
void loadConfig() {
  ...
  Serial.print((char)EEPROM.read(CONFIG_START + 0));
  Serial.print((char)EEPROM.read(CONFIG_START + 1));
  Serial.print((char)EEPROM.read(CONFIG_START + 2));
  Serial.print("...");
...
void commandConfigZone(char* params){
  ...
  //get id
  char* id = getIdFromParams(params);  
  int zoneId = -1;
