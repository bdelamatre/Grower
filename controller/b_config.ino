...
void defaultConfig(){
  ...
  configStore.schedules[2].timerStartWeekdays = "1111111";
  configStore.schedules[2].timerStartHours = "000000111111111111111100";
  //configStore.schedules[2].timerStartMinutes = "000000111111111111111100";
  for(int m=0;m<60;m++){
